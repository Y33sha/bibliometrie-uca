...
Régression : ces clauses matchaient la valeur exacte `yes`/`no` sans découper la
liste envoyée par le front. Une sélection des deux (`yes,no`) tombait dans un cas
non prévu — `in_perimeter` basculait à tort sur la seule branche `no`, n'affichant
que le hors-périmètre au lieu de tout.
"""
