...
MODULES = [
    ...
    "application.pipeline.create.create_publications",
    "application.pipeline.create.create_persons_from_source_authorships",
    "application.pipeline.build.build_authorships",
    "application.pipeline.build.populate_affiliations",
    "application.pipeline.build.populate_person_name_forms",
