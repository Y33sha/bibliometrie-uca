...
- `ror_id` : identifiant [ROR](../glossaire/ror)
...
- [**admin/structures**](../guide-utilisateur/pages-admin#admin-structures) : CRUD des structures + relations + formes de noms.
- [**admin/config**](../guide-utilisateur/pages-admin#admin-config) : CRUD des périmètres et choix du périmètre actif aux différentes étapes du pipeline.
