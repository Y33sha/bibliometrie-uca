...
- [x] Revues de même titre, seules à le porter, dont au moins une sans ISSN : même fusion automatique quand l'une est vide ou que leurs enregistrements partagent un préfixe DOI. Elle couvre 623 des 729 paires ; il s'agit surtout de livres et d'actes enregistrés depuis ScanR et depuis Crossref sous deux fiches d'éditeur.
