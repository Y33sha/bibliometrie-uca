...
- [ ] Réparation ciblée des homonymes relevés par l'audit : formes de nom égarées (Livestock Science, Psychologie du travail et des organisations, Food Science & Nutrition, Food Science and Technology), ISSN de revue portés par un livre (Reliability Engineering, Artificial Intelligence in Medicine).
