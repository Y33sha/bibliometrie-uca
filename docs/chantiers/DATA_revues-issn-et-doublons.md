...
- [ ] Oneshot : détacher de leur « revue » les chapitres et livres qui tombent sous ces règles. La suppression des revues vides emporte ensuite les fausses revues. Les recueils d'actes sont épargnés. À blanc : 4 308 enregistrements détachés de 910 revues, 1 375 publications recalculées, 849 revues vidées.
...
- [ ] Stock Crossref : réhydrater le staging depuis le raw store, puis renormaliser Crossref.
