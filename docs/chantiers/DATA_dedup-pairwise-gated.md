...
**L'audit se limite aux documents sans DOI.** Le cannot-link DOI couvre déjà les paires à DOI distincts (versions, homonymes distincts) ; les inclure n'ajouterait que du bruit. Le résidu à trancher est donc spécifiquement « même bloc, **aucun DOI** ».
