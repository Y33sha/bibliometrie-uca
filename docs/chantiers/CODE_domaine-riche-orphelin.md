...
- [ ] Brancher les VOs dans la validation des identifiants saisis par l'utilisatrice (routes d'ajout sur `person_identifiers`), en remplacement de toute validation ad hoc.
- [ ] Vérifier la cohérence du choix de VO avec `PERSON_IDENTIFIER_TYPES` / `PUBLIC_PERSON_IDENTIFIER_TYPES`.
