...
- [ ] **4d. Sujets ↔ revue** : reporté vers [METIER_sujets-qualite](METIER_sujets-qualite.md) (chantier dédié regroupant les contrôles qualité/cohérence des sujets, dont le contrôle sujet ↔ revue).
