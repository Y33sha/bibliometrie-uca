...
La [création de personnes](../pipeline/09-persons.md) se fait via les authorships des publications, indépendamment de l'existence d'une entrée `persons_rh`.
La FK sur la table `persons_rh` permet:
