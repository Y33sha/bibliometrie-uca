...
Implémenté par `infrastructure.read_models.subjects.PgSubjectsQueries`. Les écritures du référentiel, faites par la phase d'ingestion, passent par `application.ports.pipeline.subjects.SubjectsIngestionQueries`.
