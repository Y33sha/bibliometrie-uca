...
Implémenté par `infrastructure.read_models.hal_problems.PgHalProblemsQueries`.
...
from application.ports.read_models._common import PaginatedResponse, StructureRef
