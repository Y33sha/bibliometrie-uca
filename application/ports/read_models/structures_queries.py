...
Implémenté par `infrastructure.read_models.structures.PgStructuresQueries`.
...
from application.ports.read_models._common import DashboardOa, PaginatedResponse, PubYearCount
