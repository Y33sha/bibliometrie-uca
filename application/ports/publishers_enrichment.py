...
Implémenté par `infrastructure.queries.publishers_enrichment.PgPublisherEnrichmentQueries`. Consommé par `application.services.publishers.enrich_country` et le CLI de maintenance `interfaces/cli/maintenance/enrich_publishers.py`.
