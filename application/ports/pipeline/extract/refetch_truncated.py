...
class OpenalexRefetchAdapter(Protocol):
    ...
    def find_truncated(self, conn: Connection, *, limit: int | None = None) -> list[TruncatedWork]:
        ...
        Le marqueur est posé à l'extraction (payload bulk à 100 auteurs) et survit à la normalisation (qui purge `raw_data`), donc la détection ne dépend ni de l'ordre des phases ni du comptage des auteurs.
        """
