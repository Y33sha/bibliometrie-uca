 ...
 *
 * - Helpers HTTP : `api` (GET avec annulation), `post`, `put`, `patch`, `del` exposés pour les appels ad-hoc.
 * - Endpoints par domaine : exports groupés (`auth`, `persons`, `publications`, `structures`, …) — cf. fichiers frères de ce dossier.
 *
