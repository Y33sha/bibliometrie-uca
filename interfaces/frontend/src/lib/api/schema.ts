...
export interface paths {
    ...
    "/api/publications/facets/entities": {
         ...
         * @description Facette contextuelle des éditeurs, des revues, des auteurs ou des sujets : les premières entités sous les filtres actifs, avec leur décompte.
         *
...
export interface components {
    schemas: {
        ...
        /**
         * AttributionStatus
         * @description Statut d'une attribution `IdentifierAttribution ↔ Person`.
         *
        ...
        /**
         * CurationPersonOut
         * @description Fiche personne allégée, commune aux files de curation (conflits d'identifiant, doublons par nom) ; le détail complet est dans le drawer.
         */
        CurationPersonOut: {
            /** Person Id */
            person_id: number;
        ...
        /**
         * EntityFacetResponse
         * @description Facette d'entité à forte cardinalité (éditeur, revue, auteur, sujet).
         *
...
export interface operations {
    ...
    stats_entity_facet_api_stats_facets_entities_get: {
        parameters: {
            query: {
                kind: "publisher" | "journal" | "person" | "subject";
