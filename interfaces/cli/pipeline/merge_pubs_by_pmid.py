"""Point d'entrée CLI : fusion des publications par PMID."""
...
logger = setup_logger("merge_pubs_by_pmid", os.path.join(os.path.dirname(__file__), "logs"))


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fusionne les publications par PMID (cross-source)"
    )
