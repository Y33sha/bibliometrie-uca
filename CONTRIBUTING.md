...
Prérequis : comprendre l'architecture DDD en 4 couches — voir [`docs/architecture.md`](docs/architecture.md). Le modèle de données est documenté dans [`docs/donnees.md`](docs/donnees.md) ; le pipeline complet dans [`docs/pipeline.md`](docs/pipeline.md).
