...
la pastille d'une facette d'entité quand seule l'identité (l'id) est connue — typiquement au
rechargement d'une page dont l'URL ne porte que l'id. L'état canonique d'une sélection est l'id ; le
libellé en est dérivé et relu ici à la demande.
"""
