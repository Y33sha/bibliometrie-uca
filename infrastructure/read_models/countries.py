...
from application.ports.read_models.countries_queries import CountriesQueries, CountryOut
from domain.countries import NO_COUNTRY_CODE


class PgCountriesQueries(CountriesQueries):
    """Adapter SA pour `application.ports.read_models.countries_queries.CountriesQueries`."""
