"""Adapter PostgreSQL async pour journaux et éditeurs (§2.12).

Parallèle à infrastructure/repositories/journal_repository.py.
"""
...
class PgAsyncJournalRepository:
    """Accès PostgreSQL async aux agrégats Journal et Publisher."""
