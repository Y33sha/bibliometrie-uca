...
async def get_laboratory(conn: AsyncConnection, lab_id: int) -> dict[str, Any] | None:
...
async def get_laboratory_addresses(
    conn: AsyncConnection, lab_id: int, *, page: int, per_page: int
) -> dict[str, Any]:
...
async def get_laboratory_subjects(
    conn: AsyncConnection, lab_id: int, *, limit: int = 30
) -> list[dict[str, Any]]:
...
async def get_laboratory_dashboard(conn: AsyncConnection, lab_id: int) -> dict[str, Any]:
