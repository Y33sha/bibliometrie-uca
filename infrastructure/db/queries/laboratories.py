...
Implémente le port `application.ports.laboratories_queries.AsyncLaboratoriesQueries`
via `PgAsyncLaboratoriesQueries` (constructor injection de l'AsyncConnection
...
class PgAsyncLaboratoriesQueries:
    """Adapter SA pour `application.ports.laboratories_queries.AsyncLaboratoriesQueries`."""
    ...
    async def list_laboratories(self) -> list[dict[str, Any]]:
        ...
        avant de filtrer.
        """
        perimeter_ids = await async_get_persons_structure_ids_list(self._conn)
        root_ids = await async_get_persons_perimeter_root_ids(self._conn)
        rows = (
    ...
    async def get_laboratory_persons(  # noqa: C901 (4 facettes × similar conditions)
        ...
        *,
        ...
        async def run_yesno_facet(skip: str) -> Any:
...
class PgLaboratoriesQueries:
    """Variante sync de `PgAsyncLaboratoriesQueries`."""
    ...
    def get_laboratory_persons(  # noqa: C901
        self,
        lab_id: int,
        *,
        filters: Any,
