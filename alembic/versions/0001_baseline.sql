...
-- insère ensuite dans `alembic_version` sans qualifier le schéma.
-- Les CREATE TABLE qui suivent qualifient explicitement `public.foo`,
-- donc le search_path par défaut suffit.
