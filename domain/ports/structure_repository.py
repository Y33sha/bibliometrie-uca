"""Ports StructureRepository / AsyncStructureRepository — contrat d'accès
à l'agrégat Structure.

Deux variantes :
- `AsyncStructureRepository` : routers async.
- `StructureRepository` : routers sync (chantier sync-async-deduplication).
"""
...
class StructureRepository(Protocol):
    """Variante sync d'`AsyncStructureRepository`."""
