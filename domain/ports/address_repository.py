"""Ports AddressRepository / AsyncAddressRepository — contrat d'accès à
l'agrégat Address.

Deux variantes :
- `AsyncAddressRepository` : routers async.
- `AddressRepository` : routers sync (chantier sync-async-deduplication).
"""
...
class AddressRepository(Protocol):
    """Variante sync d'`AsyncAddressRepository`."""
