...
Implémenté par infrastructure/repositories/address_repository.py.
"""
...
class AsyncAddressRepository(Protocol):
    """Variante async de AddressRepository (§2.12).

    Implémentée par infrastructure/repositories/async_address_repository.py.
    """
